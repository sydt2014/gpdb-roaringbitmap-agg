...
-- for aggregations rb_or_trans pre start

CREATE OR REPLACE FUNCTION rb_or_trans_pre(internal, internal)  
     RETURNS internal  
      AS 'roaringbitmap.so', 'rb_or_trans_pre'  
     LANGUAGE C IMMUTABLE;     

-- for aggregations rb_or_trans pre end
...
-- for aggregations rb_and_trans pre start
...
-- for aggregations rb_and_trans pre end
...
-- for aggregations rb_xor_trans pre start

CREATE OR REPLACE FUNCTION rb_xor_trans_pre(internal, internal)  
     RETURNS internal  
      AS 'roaringbitmap.so', 'rb_xor_trans_pre'  
     LANGUAGE C IMMUTABLE;     

-- for aggregations rb_xor_trans pre end
